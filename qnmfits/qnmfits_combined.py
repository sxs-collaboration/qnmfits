...
def qnm_modes(chi, M, mode_dict, dest=None,
    ...
    def data_functor(t, LM):
        ...
        return data
    return modes_constructor('qnm_modes({0}, {1}, {2}, t_0={3}, t_ref={4}, **{5})'
                             .format(chi, M, mode_dict, t_0, t_ref, kwargs),
                             data_functor, **kwargs)

def qnm_modes_as(chi, M, mode_dict, W_other, dest=None,
                 t_0=0., t_ref=0.,
                 **kwargs):
    ...
    return qnm_modes(chi, M, mode_dict, dest=dest,
                     t_0=t_0, t_ref=t_ref,
...
def pick_modes_greedy(W, chi, M, target_frac, num_modes_max,
                        initial_modes_dict={}, t_0=0., t_ref=0.,
                        n_max=7, interpolate=True, use_news_power=True, retrograde=False):
    """Calculates the fraction of unmodeled power and mismatch for the
    num_modes_max number of modes.
    """
    mode_dict, Q, diff, power, mismatch = pick_nmodes_greedy(W, chi, M, target_frac,
                                                    num_modes_max, nmodes_to_report=None,
